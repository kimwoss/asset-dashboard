...
const STD_CATS = [
  ...
  { key: "기타",    kind: "생활", cur: ["기타", "구독"], ret: [] },
  // 은퇴 계획에 '모임'이 새로 생겼다(2026-09, 월 10만). 가계부에도 같은 이름의
  // 카테고리가 있으므로 한 줄로 세운다 — 종전엔 기타에 묶여 있어 은퇴 쪽 모임이
  // 매핑에 걸리지 않고 '표준 분류에 없는 항목' 경고로 떨어졌다.
  { key: "모임",    kind: "생활", cur: ["모임"],        ret: ["모임"] },
